...
import { LayoutDashboard, Users, UserCheck, Award, Search, CheckCircle, AlertCircle } from 'lucide-react';
...
const HRDashboard = () => {
  ...
  const navItems = [
    {
      id: 'interns', icon: <Users size={15} />, label: 'All Interns',
      content: (
        <div>
    ...
    {
      id: 'mentors', icon: <UserCheck size={15} />, label: 'All Mentors',
      content: (
        <div>
          <div className="page-header">
            <div>
